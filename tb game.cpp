...
int main() {
	...
	cout << "__        _______ _     ____ ___  __  __ _____   _____ ___" << endl;
	cout << "\\ \\      / / ____| |   / ___/ _ \\|  \\/  | ____| |_   _ / _ \\ " << endl;
	cout << " \\ \\ /\\ / /|  _| | |  | |  | | | | |\\/| |  _|     | | | | | |" << endl;
	cout << "  \\ V  V / | |___| |__| |__| |_| | |  | | |___    | | | |_| |" << endl;
	cout << " __\\_/\\_/_ |_____|_____\\____\\___/|_| _|_|_____|   |_| _\\___/_____ " << endl;
	cout << "/ ___|  / \\  | |/ /   / \\      / \\  |  _ \\  | |   / _ \\| |/ /_ _ |" << endl;
	cout << "\\___ \\ / _ \\ | ' /   / _ \\    / _ \\ | |_) | | |  | | | | ' / | |" << endl;
	cout << " ___) / ___ \\| . \\  / ___ \\  / ___ \\|  _ <  | |__| |_| | . \\ | |" << endl;
	cout << "|____/_/   \\_\\_|\\_\\/_/   \\_\\/_/   \\_\\_| \\_\\ |_____\\___/|_|\\_\\___|" << endl;
	...
	while (input != 'q' && hasWon == false && LokiHealth > 0) { //OMG GAME LOOP!!!
		...
		case 10:
			PetGen();
			system("color 70");
			cout << "You are in Grand Arena" << endl;
			BossBattle();
...
void BossBattle() {
	...
	while (LokiHealth > 0 && GalactusHealth > 0) { //mini game loop
		//Boss attacks loki
		num = rand() % 10; //0-9dmg
		LokiHealth -= num;
